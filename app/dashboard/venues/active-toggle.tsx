...
/**
 * Alterna `active` de um local. Não deleta: "remover da lista" preserva a linha
 * (e o slug, que pode já estar em cartaz por aí). A escrita vai por Server
 * Action, que recheca o papel no servidor — este componente é só o gatilho.
 */
...
export function VenueActiveToggle({ id, active }: { id: string; active: boolean }) {
  ...
  return (
    <button
      type="button"
      disabled={pendente}
      onClick={() => startTransition(() => void setVenueActive(id, !active))}
